...
- [Image Resolution Magnifier]([https://github.com/yangheng95/Waifu2X-Image-Scale](https://github.com/yangheng95/Waifu2X-Image-Scale)) To magnify your image, currently for animes only
- [More are on the way]
