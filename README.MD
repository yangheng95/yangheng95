...
- [Text Augmentation Tool](https://github.com/yangheng95/BoostAug): it can aceieve 1-2% or at most 5% absoulte improvement based on existing datasets and models, it will be available after peer-review 
- [More are on the way] 
